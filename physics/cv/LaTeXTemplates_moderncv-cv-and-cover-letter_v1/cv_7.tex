...
\firstname{Takuma} % Your first name
\familyname{Saito} % Your last name
...
% \phone{(000) 111 1112}
% \fax{(000) 111 1113}
\email{takuma.saito@yukawa.kyoto-u.ac.jp}
...
\cventry{2024--Present}{PhD course}{Yukawa Institute for Theoretical Physics, Kyoto University}{}{}{}  % Arguments not required can be left empty
